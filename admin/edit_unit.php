...
$clt_prdt = "SELECT * FROM `unit` where `id`='$ctgy_id'";
...
<li class="breadcrumb-item active" style="font-size: 18px;font-weight: bold;color: black !important;">Edit Unit </li>
</ol>
<div class="container-fluid">
...
<button type='submit' name="submit" class='btn btn-primary'>Submit</button> <a href="manage_unit.php?target=view_unit" class='btn btn-warning'>Back</a>
</div>
</div>
</form>
...
if($qst_ad_prdt)
{
echo "<script>window.alert('Unit updated Successfully');window.location='';</script>";
